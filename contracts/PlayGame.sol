...
contract PlayGame is Utils {
    ...
    function getGameInstantiated(address _from, address _to) public returns (address) {
        return bytes32ToAddress(gameInstantiated.get(_hashBothAddresses(_from, _to)));
    }
}
